...
func TestModelsPreserveDirectMetadataAndAppendManagedModels(t *testing.T) {
	...
	if len(catalog.Models) != 9 || catalog.Models[0].Slug != "sol" || catalog.Models[0].DisplayName != "Sol" || catalog.Models[0].ContextWindow != 872000 || catalog.Models[1].Slug != "sol-872k" || catalog.Models[1].DisplayName != "Sol (872K)" || catalog.Models[2].Slug != "managed/text-model" || catalog.Models[2].DisplayName != "Text Model (Managed)" || catalog.Models[2].ContextWindow != 1000000 || catalog.RecommendedModel != "sol" {
